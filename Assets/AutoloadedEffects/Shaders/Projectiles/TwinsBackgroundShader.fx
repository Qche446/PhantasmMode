...
float4 PixelShaderFunction(float4 sampleColor : COLOR0, float2 uv : TEXCOORD0) : COLOR0
{
    ...
    // 火焰颜色渐变
    // 从暗到亮，确保暖色成分
    float4 darkColor = isRetinazer ? float4(0.7, 0.5, 0.0, 1.0) : float4(0.0, 0.4, 0.1, 1.0);
    float4 midColor = isRetinazer ? float4(0.9, 0.7, 0.0, 1.0) : float4(0.0, 0.7, 0.2, 1.0);
    float4 lightColor = isRetinazer ? float4(1.0, 0.9, 0.0, 1.0) : float4(0.5, 1.0, 0.6, 1.0); 
