...
namespace FargosPhantasmMode.Content.Bosses.Abom
{
    ...
    {
        public override string Texture => "FargowiltasSouls/Content/Bosses/AbomBoss/AbomSword";
        ...
        public override void AI()
        {
            ...
            abom.TryGetGlobalNPC<AbomBossOverride>(out var master);
            if ((abom.velocity != Vector2.Zero || (master.AIState == master.VerticalLaevateinn && abom.ai[1] <= 60) || (master.AIState == master.Final_HorizontalLaevateinn && abom.ai[1] <= 60)) && !(master.AIState == master.VerticalLaevateinn && abom.ai[1] > 60) && !(master.AIState == master.Final_HorizontalLaevateinn && abom.ai[1] > 60))
            {
