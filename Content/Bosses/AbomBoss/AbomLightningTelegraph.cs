        ...
        public override void OnKill(int timeLeft)
        {
                ...
                if (FargoSoulsUtil.HostCheck)
                {
                    ...
                    if (p != -1)
                    {
                        ...
                        Projectile.NewProjectile(Terraria.Entity.InheritSource(Projectile), Projectile.Center, vel * 6, ModContent.ProjectileType<AbomLightningDeathray>(),
                        Projectile.damage/2, 0, Main.myPlayer, dir.ToRotation(), 1);
