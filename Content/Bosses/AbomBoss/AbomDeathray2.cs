...
{
    public class AbomDeathray2 : BaseDeathray
    {
        public override string Texture => "FargowiltasSouls/Content/Projectiles/Deathrays/AbomDeathray";
        public AbomDeathray2() : base(30, 0f, 0.4f, 3000, 15, BaseDeathray.TextureSheeting.Horizontal) { }
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] > maxTime / 2 && Projectile.scale < num801)
            {
                if (Projectile.ai[0] > 0)
                {
                    ...
                    {
                        for (int i = Main.rand.Next(250); i < 3000; i += 500)
                        {
        ...
        // Token: 0x06001249 RID: 4681 RVA: 0x00061789 File Offset: 0x0005F989
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            // 使用 PrimitiveRenderer.RenderTrail() 替代 VertexStrip
                ...
                Color brightColor = new Color(252, 252, 192, 100);
