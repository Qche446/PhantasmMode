...
{
    public class AbomShadowFlameburst : ModProjectile
    {
        public override string Texture => "Terraria/Images/Projectile_664";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Abom Flameburst");
        }
        ...
        public override void AI()
        {
            ...
            if (FargoSoulsUtil.BossIsAlive(ref EModeGlobalNPC.abomBoss, ModContent.NPCType<FargowiltasSouls.Content.Bosses.AbomBoss.AbomBoss>())
                && Main.npc[EModeGlobalNPC.abomBoss].localAI[3] > 1) // 使用憎恶的阶段判断
            {
            ...
            if (Projectile.localAI[0] > 60 && Projectile.localAI[0] < 180)
            {
                ...
                if (FargoSoulsUtil.BossIsAlive(ref EModeGlobalNPC.abomBoss, ModContent.NPCType<FargowiltasSouls.Content.Bosses.AbomBoss.AbomBoss>()))
                {
                    ...
                    // 修改：获取憎恶的目标玩家
                    Vector2 vel = Main.player[Main.npc[EModeGlobalNPC.abomBoss].target].Center - Projectile.Center;
